...
const RUNTIME_CONFIG_KEY = 'ryxen-runtime-config';
const TELEMETRY_CONSENT_KEY = 'ryxen-consent';
...
const ATHLETE_USAGE_KEY = 'ryxen-athlete-usage-v1';
const TELEMETRY_QUEUE_KEY = 'ryxen-telemetry-queue';
const APP_STATE_SYNC_KEY = 'ryxen-app-state-sync-v1';
const SYNC_OUTBOX_KEY = 'ryxen-sync-outbox-v1';
...
const {
  ...
  handleApprovePasswordResetSupportRequest,
  handleDenyPasswordResetSupportRequest,
  ...
  handleGetAthleteCheckinSessions,
  handleReserveAthleteCheckinSession,
  handleCheckInAthleteSession,
  handleCancelAthleteCheckinSession,
...
function exposeDebugAPIs() {
  ...
  const api = {
    ...
    reparseImportReview: reparsePendingImportReview,
    clearAllPdfs,
    ...
    signIn: handleSignIn,
    signInWithTrustedDevice: handleSignInWithTrustedDevice,
    ...
    getPasswordResetSupportStatus: handleGetPasswordResetSupportStatus,
    ...
    approvePasswordResetSupportRequest: handleApprovePasswordResetSupportRequest,
    denyPasswordResetSupportRequest: handleDenyPasswordResetSupportRequest,
    ...
    getAthleteCheckinSessions: handleGetAthleteCheckinSessions,
    reserveAthleteCheckinSession: handleReserveAthleteCheckinSession,
    checkInAthleteSession: handleCheckInAthleteSession,
