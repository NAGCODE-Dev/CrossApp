...
const jobs = [
  {
    ...
    outputs: [
      { size: 1024, name: 'ryxen-icon-1024.png' },
      { size: 512, name: 'ryxen-icon-512.png' },
      { size: 192, name: 'ryxen-icon-192.png' },
      { size: 180, name: 'ryxen-icon-180.png' },
      { size: 32, name: 'ryxen-icon-32.png' },
    ],
  },
  {
  ...
  },
  {
    ...
    outputs: [
      { width: 940, height: 240, name: 'ryxen-logo-white.png' },
    ],
  },
  {
    source: path.join(root, 'branding', 'ryxen-logo-black.svg'),
    outputs: [
      { width: 940, height: 240, name: 'ryxen-logo-black.png' },
    ],
  },
];
